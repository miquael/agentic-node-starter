...
- **Security**: Local setup uses `mythic-pnpm-only-security-setup.sh`. Check for this before setup tasks.
- **Constraints**: Adhere to `.ai/docs/steering.md`.
- **Ignored**: **Never** read, search, or modify `.human/` (out-of-context archives).
